...
Atrib : TK_IDENTIFICADOR '=' Expr { $$ = asd_new("="); asd_add_child($$,asd_new(create_leaf($1))); asd_add_child($$,$3); if(hash_table_lookup($1.value.valueChar) == NULL) { printf("ERR_UNDECLARED"); return ERR_UNDECLARED; } else{print_table();} }
